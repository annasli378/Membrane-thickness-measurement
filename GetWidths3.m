function widths = GetWidths3(start,step, mask_atr, numBlobs, show_plots)
...
for i = 1:numBlobs
    ...
    for s=start:step:stop
        ...
        x_l = skel_pix(s-5,1); y_l = skel_pix(s-5,2);
        x_p = skel_pix(s+5,1); y_p = skel_pix(s+5,2); 
